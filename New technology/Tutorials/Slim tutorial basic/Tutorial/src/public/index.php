...
$app->post('/ticket/new', function (Request $request, Response $response) {
    ...
    $response = $response->withRedirect("/Tutorial-First-Application-master/src/public/tickets");
    return $response;
});
...
$app->delete('/ticket/delete/{id}', function (Request $request, Response $response, $args) {
    /* STAP 1 */
    $id = (int)$args['id'];
    $mapper = new TicketMapper($this->db);
    $mapper->delete($id);
...
$app->get('/ticket/edit/{id}', function (Request $request, Response $response, $args) {
    /* STAP 1 */
    $ticket_id = (int)$args['id'];
    $mapper = new TicketMapper($this->db);
    $ticket = $mapper->getTicketById($ticket_id);
